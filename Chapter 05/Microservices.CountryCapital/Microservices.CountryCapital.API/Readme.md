...
Execute unit tests
```
    cd "Microservices.CountryCapital.API/test/Microservices.CountryCapital.API.Tests"
    dotnet test
```

Deploy application
```
    cd "Microservices.CountryCapital.API/src/Microservices.CountryCapital.API"
